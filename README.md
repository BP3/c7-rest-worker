...
| CAMUNDA_VERSION             | The version of Camunda 7 that we are building against | 7.23.0         |
| CAMUNDA_HTTP_CLIENT_VERSION | The version of the Camunda HTTP Client to use         | 1.6.0          |

## Building the docker image locally

```bash
docker build -t c7-rest-worker:7.23.0 .
```
...
$ docker run -it --rm \
    ...
    -e ENGINE_ENDPOINT=http://c7host.mynet/engine-rest \
          bp3/camunda7/c7-rest-worker:7.23.0 [options]
